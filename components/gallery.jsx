...
class Gallery extends Component
{
    ...
    render()
    {
        return ( <div>
            ...
            <img className="image" src="https://www.99bestquoteswishes.com/wp-content/uploads/2015/12/protecting-your-reputation-About-Us1.jpg"  alt="Card image cap"/>
            <div className="middle">
            <div className="textabout">{this.props.about}</div>
            </div>
           </div>    
            </div>     
