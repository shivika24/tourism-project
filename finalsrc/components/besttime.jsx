        ...
        return(
            ...
            {this.state.loading||!this.state.cli?(
                <div>{console.log('loading')}</div>):(
                    <div>
                    {console.log(this.state.cli.currently.temperature)}
                       ...
                       {this.f1(this.state.cli.currently.icon)
                       }
                       {console.log(this.state.cli.daily)}
                       <img id="weatdiv"/>                       
                       <center><h3>{this.state.cli.currently.temperature}°F</h3></center>
                       <center><p>UPCOMING</p></center>
                       <div className="row">
                       {this.state.cli.daily.data.map((i)=>{return <div className="col-4">
                        <p>{i.temperatureHigh}°F</p><p>{i.summary}</p></div>})}
                        </div>
                       </div>
                       </div>
                       </div>
